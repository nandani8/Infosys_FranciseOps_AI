...
> Replace the placeholders below with actual screenshots taken from your running Cloudflare Tunnel URL before submission.

### Login / Authentication Portal
`[ SCREENSHOT PLACEHOLDER — Sign In / Sign Up / Recover Password tabs ]`

### Admin Dashboard
`[ SCREENSHOT PLACEHOLDER — user list, promote/demote/unlock controls ]`

### AI Copilot
`[ SCREENSHOT PLACEHOLDER — multilingual chat response with grounded source citation ]`

### Agent 1 — Outlet Performance
`[ SCREENSHOT PLACEHOLDER — metrics, revenue prediction chart, simulator ]`

### Agent 3 — Staff Productivity
`[ SCREENSHOT PLACEHOLDER — attrition risk radar, trained model output tab ]`

### Agent 6 — Customer Sentiment
`[ SCREENSHOT PLACEHOLDER — live sentiment analyzer with polarity gauge ]`

### Agent 9 — PDF SOP & Agreement RAG Studio
`[ SCREENSHOT PLACEHOLDER — PDF upload and grounded Q&A over the document ]`
